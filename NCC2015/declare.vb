...
Module mo_declare
    ...
    Public Declare Function rf_beep Lib "MasterRD.dll" (ByVal icdev As Short, ByVal ms As Byte) As Integer

    Public Declare Function rf_light Lib "MasterRD.dll" (ByVal icdev As Short, ByVal color As Byte) As Integer
End Module